        ...
        <div class="container d-flex justify-content-between align-items-center">
            <div class="d-inline-flex align-items-center gap-3">
                <a href="mailto:mandar.c@insysindia.com" class="d-inline-flex align-items-center gap-2 lh-1 lead-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" height="18" width="18" viewBox="0 0 512 512"><path fill="#f15034" d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
                    <span>mandar.c@insysindia.com</span>
                </a>
                <a href="tel:8108106990" class="d-inline-flex align-items-center gap-2 lh-1 lead-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" height="18" width="16" viewBox="0 0 448 512"><path fill="#f15034" d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm90.7 96.7c9.7-2.6 19.9 2.3 23.7 11.6l20 48c3.4 8.2 1 17.6-5.8 23.2L168 231.7c16.6 35.2 45.1 63.7 80.3 80.3l20.2-24.7c5.6-6.8 15-9.2 23.2-5.8l48 20c9.3 3.9 14.2 14 11.6 23.7l-12 44C336.9 378 329 384 320 384C196.3 384 96 283.7 96 160c0-9 6-16.9 14.7-19.3l44-12z"/></svg>
    ...
    <nav class="navbar navbar-expand-lg smart-scroll py-3" id="mainNav">
        <div class="container position-relative">   
            ...
            <div class="d-inline-flex align-items-center gap-3"> 
                <a href="#" class="btn btn-primary height gap-2 text-uppercase d-none d-sm-inline-flex">
                    ...
                    <ul class="collapse" id="collapse2"> 
                        <li>
                            ...
                            <ul class="collapse" id="collapse3"> 
                                <li><a href="<?php echo $base_url;?>residential-gas-metering.php">Residential Gas Metering</a></li>
                                <li><a href="#">Commercial Diaphragm Meters</a></li>
                                <li><a href="#">RPD Meters</a></li>
                                <li><a href="#">Turbine Meters</a></li>
                                <li><a href="#">Electronic Volume Correctors</a></li>
                            </ul>
                        </li>   
                        <li>
                            ...
                            <ul class="collapse" id="collapse4"> 
                                <li><a href="#">PD Meter for Liquid</a></li>
                                <li><a href="#">Water Cut Meters</a></li>
                                <li><a href="#">V Cone Meters</a></li>
                                <li><a href="#">MPFM Meters</a></li>
                            </ul>
                        </li>   
                        <li>
                            ...
                            <ul class="collapse" id="collapse5"> 
                                <li><a href="#">Flow Computers</a></li>
                                <li><a href="#">Gas Chromatographs</a></li>
                                <li><a href="#">Metering & Regulating Skid</a></li> 
                            </ul>
                        </li>   
                        <li>
                            ...
                            <ul class="collapse" id="collapse6"> 
                                <li><a href="#">H2S Analyzer</a></li>
                                <li><a href="#">Ammonia Analyzer</a></li> 
                            </ul>
                        </li>   
                        <li>
                            <a class="btn__link collapsed" data-bs-toggle="collapse" href="#collapse6" role="button" aria-expanded="false" aria-controls="collapse6">
